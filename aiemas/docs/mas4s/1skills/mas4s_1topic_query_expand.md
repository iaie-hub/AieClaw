## 检索增强查询拓展 Agent (Question: Query Expand) 设计方案
...
```bash
python3 scripts/mas4s_question_query_expand.py '{"idea": "研究多智能体协作中的长期记忆管理", "run_id": "run_20260423"}'
```
...
- **进度文件路径**：`~/.openclaw/workspace-<agentId>/task/<run_id>/progress_mas4s_question_query_expand.jsonl`
