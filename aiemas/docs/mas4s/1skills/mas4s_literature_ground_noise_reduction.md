...
**输入文件 2 (原文)**：`~/.openclaw/workspace-literature-ground/task/{run_id}/arxiv_search_results.json`
...
```bash
python3 scripts/mas4s_literature_ground_noise_reduction.py '{"run_id": "run_20260424"}'
```
