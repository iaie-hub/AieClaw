...
- `evidence_report.md`：人机共读的全景审计报告。
...
```bash
python3 scripts/mas4s_evidence_literature_graph.py '{"run_id": "run_222"}'
```

#### 6.2 目录结构示例

```
~/.openclaw/workspace-evidence/task/run_222/
├── pi_result.json
├── parsed_papers.json
├── papers/
│   └── 2604.20300/
...
- **进度文件路径**：`~/.openclaw/workspace-evidence/task/<run_id>/progress_mas4s_literature_graph.jsonl`
