# Skill: mas4s-literature-ground-pdf-to-markdown

## 设计理念 (Design Philosophy)

学术论文通常采用复杂的多栏排版，并包含大量的数学公式、图表和引用，传统的 OCR 或规则解析方法难以保证语义的完整性。`mas4s-literature-ground-pdf-to-markdown` 技能通过引入**多模态大模型 (VLM)** 视觉解析能力，将 PDF 逐页转换为高保真的 Markdown 文献。
