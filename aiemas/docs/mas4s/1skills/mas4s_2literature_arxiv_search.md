## 事实定标学术搜索 Agent (Evidence arXiv Search) 设计方案
...
```bash
python3 scripts/mas4s_evidence_arxiv_search.py '{"run_id": "run_20260424"}'
```
...
- **进度文件路径**：`~/.openclaw/workspace-<agentId>/task/<run_id>/progress_mas4s_evidence_arxiv_search.jsonl`
