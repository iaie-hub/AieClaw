# Skill: mas4s-literature-ground-pdf-download

## 设计理念 (Design Philosophy)

在科学研究生命周期中，获取原始文献全文是深度分析的基础。`mas4s-literature-ground-pdf-download` 技能专门负责从 arXiv 等学术平台自动化、高可靠地获取 PDF 文件。
...
### 输出 (Output)
- **物理文件**：`~/.openclaw/workspace-literature-ground/task/<run_id>/papers/<arXiv.ID>/paper.pdf`
