...
- **技能调用**：[`mas4s-literature-search`](file:///Users/admin/.openclaw/skills/mas4s-literature-search/SKILL.md)
...
- **技能调用**：[`mas4s-literature-filter`](file:///Users/admin/.openclaw/skills/mas4s-literature-filter/SKILL.md)
...
- **技能调用**：[`mas4s-literature-download`](file:///Users/admin/.openclaw/skills/mas4s-literature-download/SKILL.md)
...
- **技能调用**：[`mas4s-literature-parse`](file:///Users/admin/.openclaw/skills/mas4s-literature-parse/SKILL.md)
- **输入**：步骤 4 下载的 PDF 文件。
...
- **技能调用**：[`mas4s-literature-probe`](file:///Users/admin/.openclaw/skills/mas4s-literature-probe/SKILL.md)
...
- **技能调用**：[`mas4s-literature-deconstruct`](file:///Users/admin/.openclaw/skills/mas4s-literature-deconstruct/SKILL.md)
...
- **技能调用**：[`mas4s-literature-critique`](file:///Users/admin/.openclaw/skills/mas4s-literature-critique/SKILL.md)
...
- **技能调用**：[`mas4s-literature-synthesize`](file:///Users/admin/.openclaw/skills/mas4s-literature-synthesize/SKILL.md)
...
- **支持 run_id 参数 (必需)**：Skill 必须接收 `run_id` 命令行参数.
  ...
  - **参考**：参见 [`pdf_to_markdown` 技能定义](file:///Users/admin/.openclaw/skills/pdf_to_markdown/SKILL.md) 中的 `run_id` 参数规范.
