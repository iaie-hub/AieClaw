# 证据底座 Agent (Science Assistant: Evidence)

## 1. 概述 (Overview)

**Science Assistant: Evidence** 是专门用于事实定标与文献底座构建的智能 Agent。其核心目标是接收阶段 1 产出的科研课题定义（`pi_result.json`），通过系统化的 SOP 流程，对目标方向进行深度文献挖掘、智能降噪、逐篇精读与结构化提取，最终聚合产出一个极其精炼、以知识图谱为载体的文献底座，为后续可行性推演提供扎实的事实基础。
...
- **技能调用**：[`mas4s-evidence-arxiv-search`](file:///Users/admin/clawd/skills/mas4s-evidence-arxiv-search/SKILL.md) (参考：[技能文档](../1skills/mas4s_2evidence_arxiv_search.md))
...
- **技能调用**：[`mas4s-evidence-noise-reduction`](file:///Users/admin/clawd/skills/mas4s-evidence-noise-reduction/SKILL.md) (参考：[技能文档](../1skills/mas4s_2evidence_noise_reduction.md))
...
- **技能调用**：[`mas4s-evidence-pdf-download`](file:///Users/admin/clawd/skills/mas4s-evidence-pdf-download/SKILL.md) (参考：[技能文档](../1skills/mas4s_2evidence_pdf_download.md))
...
- **技能调用**：[`mas4s-evidence-pdf-to-markdown`](file:///Users/admin/clawd/skills/mas4s-evidence-pdf-to-markdown/SKILL.md) (参考：[技能文档](../1skills/mas4s_2evidence_pdf_to_markdown.md))
- **输入**：步骤 4 下载的 PDF 文件。
...
- [阶段 1：Question Agent](./science_assistant_1question.md)
