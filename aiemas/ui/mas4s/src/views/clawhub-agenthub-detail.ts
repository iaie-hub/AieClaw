      ...
      <div class="container">
        ...
        <div class="title-card">
          <div class="header-info">
            <div class="title-row">
              ...
              <div class="visibility ${a.visibility} ${a.can_manage ? 'can-manage' : ''}" 
                   title=${a.can_manage ? '点击切换可见性' : (a.visibility === "public" ? "公开 (Public)" : "私有 (Private)")}
                   @click=${this._handleVisibilityToggle}>
                ${a.visibility === "public"
                  ? html`<svg viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a5 5 0 00-5 5v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2H9V7a1 1 0 012 0v2h2V7a5 5 0 00-5-5z"/></svg>`
                  : html`<svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"/></svg>`}
        ...
        <section class="detail-card">
          ...
          <dl class="dl-list">
            ...
            <div class="dl-item">
              <dt>Package Size</dt>
              <dd class="mono" style="background: #f8fafc; border-color: #f1f5f9; display: inline-block;">${this._formatSize(a.file_size)}</dd>
            </div>
        ...
        <section class="detail-card">
          ...
          <div class="description-container">
            <div class="description-content ${this._descriptionExpanded || !showExpandBtn ? "" : "collapsed"}">
              ${markdownMath(a.description || "No description provided.")}
            </div>
            ${!this._descriptionExpanded && showExpandBtn ? html`<div class="fade-overlay"></div>` : ""}
            ${showExpandBtn
              ? html`
                  <button class="expand-btn" @click=${this._toggleDescription}>
                    ${this._descriptionExpanded ? "收起" : "展开"}
                    <svg class="${this._descriptionExpanded ? "rotated" : ""}" viewBox="0 0 20 20" fill="currentColor">
