...
type GatewayRequestContextParams = {
  ...
  onSessionCreated?: GatewayRequestContext["onSessionCreated"];
  onBeforeRequest?: GatewayRequestContext["onBeforeRequest"];
  filterSessionsList?: GatewayRequestContext["filterSessionsList"];
};
...
export function createGatewayRequestContext(
  ...
  return {
    ...
    onBeforeRequest: params.onBeforeRequest,
    filterSessionsList: params.filterSessionsList,
  };
}
