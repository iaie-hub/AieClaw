...
let globalJitiLoader: ReturnType<typeof createJiti> | null = null;

export function setGlobalJitiLoader(loader: ReturnType<typeof createJiti> | null) {
  globalJitiLoader = loader;
}

export function getGlobalJitiLoader(): ReturnType<typeof createJiti> | null {
  return globalJitiLoader;
}
...
function getJiti(modulePath: string) {
  ...
  return getLoader(cacheKey, aliasMap, tryNative);
}

function getLoader(cacheKey: string, aliasMap: Record<string, string>, tryNative: boolean) {
  if (globalJitiLoader) {
    return globalJitiLoader;
  }
